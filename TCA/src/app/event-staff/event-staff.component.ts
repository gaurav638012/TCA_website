...
@Component({
  ...
  styleUrls: ['./event-staff.component.css'],
  ...
  Book(random_token:any):any{
    ...
    var info = {
      ...
      'name': localStorage.getItem('name'), 'mobile': localStorage.getItem('mobile'), 'department': localStorage.getItem('department'),
       'email': localStorage.getItem('email'),'subscribed': 'no', 'total_amount': this.total.toString(), 'contribution': this.f['contribution'].value,
